...
@Component({
  selector: 'app-drought-reported',
  templateUrl: './drought-reported.component.html',
  styleUrls: ['./drought-reported.component.scss'],
})
export class DroughtReportedComponent implements OnInit {
  @Input('item') item: any;
