...
@Component({
  selector: 'app-volcano-reported',
  templateUrl: './volcano-reported.component.html',
  styleUrls: ['./volcano-reported.component.scss'],
})
export class VolcanoReportedComponent implements OnInit {
  @Input('item') item: any;
