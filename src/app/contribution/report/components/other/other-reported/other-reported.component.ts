...
@Component({
  selector: 'app-other-reported',
  templateUrl: './other-reported.component.html',
  styleUrls: ['./other-reported.component.scss'],
})
export class OtherReportedComponent implements OnInit {
  @Input('item') item: any;
