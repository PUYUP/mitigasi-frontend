...
@Component({
  selector: 'app-tsunami-reported',
  templateUrl: './tsunami-reported.component.html',
  styleUrls: ['./tsunami-reported.component.scss'],
})
export class TsunamiReportedComponent implements OnInit {
  @Input('item') item: any;
