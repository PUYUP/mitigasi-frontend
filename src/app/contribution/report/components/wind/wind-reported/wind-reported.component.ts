...
@Component({
  selector: 'app-wind-reported',
  templateUrl: './wind-reported.component.html',
  styleUrls: ['./wind-reported.component.scss'],
})
export class WindReportedComponent implements OnInit {
  @Input('item') item: any;
