...
@Component({
  selector: 'app-wildfire-reported',
  templateUrl: './wildfire-reported.component.html',
  styleUrls: ['./wildfire-reported.component.scss'],
})
export class WildfireReportedComponent implements OnInit {
  @Input('item') item: any;
