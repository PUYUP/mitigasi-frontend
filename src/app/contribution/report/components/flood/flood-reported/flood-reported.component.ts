...
@Component({
  selector: 'app-flood-reported',
  templateUrl: './flood-reported.component.html',
  styleUrls: ['./flood-reported.component.scss'],
})
export class FloodReportedComponent implements OnInit {
  @Input('item') item: any;
