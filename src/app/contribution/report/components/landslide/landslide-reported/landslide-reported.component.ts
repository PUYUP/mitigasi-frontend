...
@Component({
  selector: 'app-landslide-reported',
  templateUrl: './landslide-reported.component.html',
  styleUrls: ['./landslide-reported.component.scss'],
})
export class LandslideReportedComponent implements OnInit {
  @Input('item') item: any;
